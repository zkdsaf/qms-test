<template>
  <n-layout-sider bordered collapse-mode="width" :collapsed-width="64" :width="240" :collapsed="collapsed" show-trigger @collapse="collapsed = true" @expand="collapsed = false">
    <n-menu :collapsed-width="64" :collapsed-icon-size="22" :collapsed="collapsed" :options="filteredMenuOptions" @update:value="handleUpdateValue" :default-value="defaultPath" />
  </n-layout-sider>
</template>
...
// 过滤菜单选项
const filteredMenuOptions = computed(() => filterMenuOptions(rawMenuOptions.value, userRole.value, currentSystem.value))
