<template>
  ...
  >
    ...
    <template #purchaseManager-suffix>
      <n-icon
        size="23"
        :component="UserOutlined"
        class="cursor-pointer"
    ...
    <template #materialManager-suffix>
      <n-icon
        size="23"
        :component="UserOutlined"
        class="cursor-pointer"
    ...
    <template #materialManagerLeader-suffix>
      <n-icon
        size="23"
        :component="UserOutlined"
        class="cursor-pointer"
