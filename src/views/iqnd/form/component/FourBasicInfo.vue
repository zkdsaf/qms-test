...
const formData = ref({
  ...
  vendorName: '示例供应商',
  materialType: 'admin',
  defectCategory: 'admin',
  defectType: 'admin',
  defectLevel: 'admin',
  occurTime: Date.now(),
  incomingTime: Date.now(),
  puchaseLocation: '示例地点',
  puchaseOrderNo: 'PO2024001',
  abnormalDesc: '示例异常描述',
  file: [],
  materialTableData: [
    {
      ...
      materialNo: 'M001',
      materialName: '示例物料',
      materialDescription: '示例物料描述',
      manufacturerName: '示例制造商',
      incomingMax: '10',
      incomingMaxBatch: '5',
      incomingMin: '1',
      abnormalBatch: 'B001',
      abnormalBatchQty: '100',
      abnormalQty: '50',
      unit: '个',
    },
  ],
...
const materialTableColumns = [
  ...
  },
  {
    ...
    render: (row, index) => (
      <NFormItem
        path={`materialTableData[${index}].manufacturerName`}
        rule={{
          required: true,
          message: '请输入',
          trigger: ['input', 'blur'],
